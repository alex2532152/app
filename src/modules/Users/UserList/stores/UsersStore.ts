...
export class UsersStore {
  usersState?: PromiseObserver<AxiosResponse<UsersData>, AxiosError>;

  newUsersState?: PromiseObserver<AxiosResponse<UsersData>, AxiosError>;
  ...
  getUserData = async () => {
    const promise = axios.get(
      `https://dummyjson.com/users${this.searchTream ? '/search' : ''}`,
      {
        params: {
